...
<body>
                ...
                <div class='f-col new-staff-acc-form-wrapper'> 
                    <header class='f-row form-header'>
                        <div class='f-center f-row'>
                            ...
                            <h4>Update Staff Account | <?= $staff['username'] ?></h4>
                        </div>
                        <p><?= date('Y') ?></p>
                    </header>
                        ...
                        <div class='f-col form-content-wrapper'>
                            ...
                            <section class='f-col account-info-container'>
                                ...
                                <div class='f-col'>
                                    ...
                                    <input class='no-form-input' type='text' data-input='Username' name='username' id='username' placeholder='Enter Username' value='<?= $username ?>'>
                                    <p class='error-info un-err'></p>
                                </div>
                                <button class='reset-pass-btn'>Reset Password</button>
                                <div class='f-col account-info-container reset-pass-wrapper'>
                                    <div class='f-col'>
    ...
    <script type='module' src=<?=  getScript('admin.update-staff-acc'); ?>></script>
</body>
</html>