...
class PDF extends FPDF 
{
    ...
    function FancyTable($header, $data) 
    {
        ...
        $this->SetFont('','B', 10);
                  ...
                  //ID,Name,Gender,number,email,position,handle,status,date,profile
        $w = array(44, 27, 35, 39, 29, 45, 32, 32);
        ...
        foreach($data as $row) 
        {
            ...
            $this->Cell($w[1],6,$row['gender'],'LR',0,'C',$fill); 
...
$pdf = new PDF('L');
$pdf->SetTitle("BARANGAY SAN NICOLAS OFFICIALS");
