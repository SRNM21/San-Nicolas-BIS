...
$hotline_images = [getImage('pasigc3.png'), getImage('polays.png'), getImage('firedept.png'), getImage('pcgh.png'), getImage('dswdncr.png'), getImage('dilg.png'), getImage('nbi.svg')];
