...
famHeadSubmit.click(function(e)
{
    ...
    if (validLName && validFName && validMName && validBDay && validCivil && validPnum && validEmail && validPurok && validAddress)
    {
...
{  
    ...
    if (validLName && validFName && validMName && validSex && validBDay && validPOB && validEmail && validIS && validPurok && validAddress && validMedHis && validRes)
    {
...
{  
    ...
    if (validLName && validFName && validMName && validCivil && validBDay && validEmail && validPurok && validAddress)
    {
        $('#spouse-form').submit()
    }
})